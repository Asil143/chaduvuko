...
export default function PythonSectionNav({ slug }: { slug: string }) {
  const section = PYTHON_CURRICULUM.find(s => s.modules.some(m => m.slug === slug))
  ...
  return (
    <div style={{ marginBottom: 36 }}>
      ...
      <nav style={{ display: 'flex', alignItems: 'center', gap: 6, marginBottom: 14, flexWrap: 'wrap' }}>
        <Link href="/learn/python" style={{ fontSize: 12, color: 'var(--muted)', textDecoration: 'none', fontFamily: 'var(--font-mono)' }}>
          Python
        </Link>

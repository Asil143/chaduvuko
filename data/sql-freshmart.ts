...
export const SQL_CURRICULUM: SQLSection[] = [
  ...
  },
  {
    ...
    modules: [
      { id: 60, slug: 'sql-for-data-analysis',    title: 'SQL for Data Analysis',                     description: 'Real case studies using Swiggy, Zepto, HDFC, and FreshMart data', tags: ['Swiggy case study','Zepto data','HDFC analysis','FreshMart full query'],                                                              status: 'live', readTime: '28–36 min' },

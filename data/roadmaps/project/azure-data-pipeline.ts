...
export const azureDataPipelineRoadmap: Roadmap = {
  ...
  nodes: [
    ...
    { id: 'freshmart-intro', title: 'FreshCart Dataset', type: 'required', description: 'FreshCart is a fictional grocery chain with 10 stores across US cities — ST001 through ST010. Files are named store_ST001_sales_YYYYMMDD.csv and stored in Azure Blob (landing) before moving to ADLS Gen2. Same dataset across all 6 projects so skills compound.', time: '30 min', difficulty: 'beginner', row: 1, col: 0 },

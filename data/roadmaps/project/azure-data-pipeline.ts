...
export const azureDataPipelineRoadmap: Roadmap = {
  ...
  category: 'project',
  description: 'Six end-to-end ADF projects — from copying a single CSV to pulling live REST API data. Every project uses the same FreshCart grocery chain dataset so skills compound.',
  totalTime: '6–8 weeks',
  ...
  sections: [
    ...
    { row: 1, label: 'The FreshCart Dataset', color: '#00e676' },
    { row: 2, label: 'Six Projects — Build In Order', color: '#0078d4', description: 'All projects use the same FreshCart fictional grocery chain. 10 stores, real CSV files, real errors, real fixes.' },
  ...
  nodes: [
    ...
    { id: 'freshmart-intro', title: 'FreshCart Dataset', type: 'required', description: 'FreshCart is a fictional grocery chain with 10 stores across Indian cities — ST001 through ST010. Files are named store_ST001_sales_YYYYMMDD.csv and stored in Azure Blob (landing) before moving to ADLS Gen2. Same dataset across all 6 projects so skills compound.', time: '30 min', difficulty: 'beginner', row: 1, col: 0 },
    ...
    { id: 'p01', title: 'Project 01 — Copy a CSV', type: 'chaduvuko', description: 'Copy a single FreshCart CSV from Azure Blob Storage to ADLS Gen2 using one Copy Activity. Set up two Linked Services and two Datasets from scratch. The simplest possible pipeline — but you will hit real errors on connection strings and IAM permissions.', time: '3–4 hrs', difficulty: 'beginner', href: '/learn/projects/azure-batch-pipeline', row: 2, col: 0 },
    ...
    { id: 'next-aws', title: 'Replicate on AWS', type: 'optional', description: 'Build an equivalent pipeline on AWS — S3 as landing, Glue for transformation, Redshift as warehouse. Same FreshCart data, different cloud. Once you know ADF, Glue takes half the time.', time: '1–2 weeks', difficulty: 'intermediate', row: 3, col: 2 },
  ],
}
...
export const azureRoadmap: Roadmap = {
  ...
  nodes: [
    ...
    // Chaduvuko Projects
    { id: 'az-p01', title: 'Project 01 — Copy CSV', type: 'chaduvuko', description: 'First ADF pipeline. Copy a FreshCart CSV from Blob to ADLS Gen2. Set up Linked Services, create Datasets, wire a Copy Activity, and run it.', time: '3–4 hrs', difficulty: 'beginner', href: '/learn/projects/azure-batch-pipeline', row: 6, col: 0 },

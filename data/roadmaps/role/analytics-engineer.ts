...
export const analyticsEngineerRoadmap: Roadmap = {
  ...
  category: 'role',
  description: 'The path that sits between data engineering and data analysis. SQL, dbt, dimensional modelling, modern data warehouses, and making data trustworthy for business teams. A fast-growing role at startups and enterprises alike.',
  level: 'beginner',
  estimatedTime: '3–5 months',
  salaryData: [
    { company: 'Startup / Analytics firm', range: '$75K–$100K', note: 'Growing but still emerging role' },
    { company: 'Mid-size startup', range: '$105K–$140K', note: 'DoorDash, Shopify, Stripe data teams' },
    { company: 'Enterprise (analytics)', range: '$135K–$170K', note: 'dbt + warehouse expertise' },
    { company: 'Data-first product company', range: '$155K–$210K', note: 'Full modern data stack' },
  ],
  nodes: [
    ...
    { id: 'warehouse', title: 'Data Warehouse (BigQuery / Snowflake / Redshift)', type: 'required', xp: 15, prerequisites: ['sql'], difficulty: 'intermediate', time: '6 hrs', description: 'Columnar storage, partitioning, clustering, cost optimisation, warehousing concepts. Pick one and go deep — all are widely used.', x: 230, y: 220, width: 130, height: 60 },

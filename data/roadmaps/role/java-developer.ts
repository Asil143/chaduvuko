...
export const javaDeveloperRoadmap: Roadmap = {
  ...
  category: 'role',
  description: 'From Java fundamentals through Spring Boot, JPA, microservices, Kafka, and cloud deployment. Java is the dominant language at banks, fintech, and large enterprises — Accenture, Deloitte, Stripe, and JPMorgan.',
  level: 'beginner',
  estimatedTime: '4–5 months',
  salaryData: [
    { company: 'Consulting (Accenture, KPMG)', range: '$65K–$90K', note: 'Most common entry; Spring Boot expected' },
    { company: 'Fintech startup', range: '$105K–$140K', note: 'Stripe, Square, Braintree' },
    { company: 'Enterprise (SAP, Oracle)', range: '$135K–$175K', note: 'Enterprise Java experience' },
    { company: 'FAANG', range: '$175K–$230K', note: 'Deep DSA + distributed systems' },
  ],
  nodes: [
    ...
    { id: 'dsa', title: 'DSA & Algorithms', type: 'required', xp: 20, prerequisites: ['collections'], difficulty: 'advanced', time: '25 hrs', description: 'LeetCode Medium problems in Java. Every $130K+ offer has a DSA round — no shortcuts.', x: 530, y: 320, width: 130, height: 60 },
    { id: 'kafka', title: 'Kafka', type: 'recommended', xp: 12, prerequisites: ['springboot'], difficulty: 'advanced', time: '6 hrs', description: 'Producers, consumers, consumer groups, partitioning, Spring Kafka. Async messaging at fintech scale.', x: 80, y: 420, width: 130, height: 60 },
    { id: 'microservices', title: 'Microservices', type: 'required', xp: 15, prerequisites: ['springboot', 'docker'], difficulty: 'advanced', time: '8 hrs', description: 'Service decomposition, Feign clients, API gateway, distributed tracing, circuit breakers (Resilience4j). How large systems are structured.', x: 230, y: 420, width: 130, height: 60 },
    { id: 'cloud', title: 'Cloud Deploy (AWS / Azure)', type: 'required', xp: 12, prerequisites: ['docker', 'microservices'], difficulty: 'advanced', time: '6 hrs', description: 'ECS/EKS, App Service, RDS, managed queues. Enterprise Java runs on cloud.', x: 380, y: 420, width: 130, height: 60 },
  ],
  edges: [

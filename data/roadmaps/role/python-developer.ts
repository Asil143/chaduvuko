...
export const pythonDeveloperRoadmap: Roadmap = {
  ...
  category: 'role',
  description: 'Comprehensive path to professional Python development. Covers the language deeply, then moves to web APIs (FastAPI), databases, testing, packaging, async programming, and cloud deployment.',
  level: 'beginner',
  estimatedTime: '3–4 months',
  salaryData: [
    { company: 'Service / Outsourcing', range: '$70K–$95K', note: 'Entry point for most' },
    { company: 'Startup (fintech / e-comm)', range: '$105K–$140K', note: 'FastAPI + testing expected' },
    { company: 'Enterprise', range: '$135K–$175K', note: 'Strong DSA + design patterns' },
    { company: 'FAANG', range: '$175K–$230K', note: 'Top-tier DSA required' },
  ],
  nodes: [
    ...
    { id: 'fastapi', title: 'FastAPI', type: 'required', xp: 15, prerequisites: ['oop', 'sql'], difficulty: 'intermediate', time: '7 hrs', description: 'Routes, Pydantic models, dependency injection, middleware, async handlers. The standard Python web framework at modern startups.', x: 230, y: 320, width: 130, height: 60 },

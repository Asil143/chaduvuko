...
export const aiEngineerRoadmap: Roadmap = {
  ...
  category: 'role',
  description: 'Practical path to AI Engineering. From Python and deep learning fundamentals through LLMs, RAG systems, multi-agent frameworks, and production AI deployment — the most in-demand tech role of 2025–26.',
  level: 'intermediate',
  estimatedTime: '4–6 months',
  salaryData: [
    { company: 'Startup (early stage)', range: '$110K–$150K', note: 'Portfolio of shipped AI features needed' },
    { company: 'Product Company (Anthropic, Mistral)', range: '$150K–$220K', note: 'Deep LLM knowledge expected' },
    { company: 'Enterprise (Microsoft, Google)', range: '$190K–$260K', note: 'Research + engineering mix' },
    { company: 'FAANG', range: '$230K–$340K', note: 'Extremely competitive' },
  ],
  nodes: [
    ...
    { id: 'rag', title: 'RAG Systems', type: 'required', xp: 15, prerequisites: ['vectordb', 'prompt'], difficulty: 'intermediate', time: '8 hrs', description: 'Retrieval-augmented generation, chunking strategies, re-ranking, hybrid search. RAG is the dominant pattern for enterprise AI.', x: 230, y: 320, width: 130, height: 60 },

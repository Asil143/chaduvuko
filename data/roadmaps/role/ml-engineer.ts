...
export const mlEngineerRoadmap: Roadmap = {
  ...
  category: 'role',
  description: 'End-to-end path to becoming an ML Engineer. From Python and maths foundations through scikit-learn, PyTorch, MLOps, and deploying models on SageMaker and Vertex AI.',
  level: 'intermediate',
  estimatedTime: '4–6 months',
  salaryData: [
    { company: 'Service (Deloitte, KPMG)', range: '$95K–$125K', note: 'Most common entry point' },
    { company: 'Startup (Shopify, Scale AI)', range: '$150K–$195K', note: 'Strong ML portfolio needed' },
    { company: 'Enterprise (Microsoft, Google)', range: '$190K–$240K', note: 'Big tech ML teams' },
    { company: 'FAANG', range: '$235K–$330K', note: 'Extremely competitive' },
  ],
  nodes: [
    ...
    { id: 'pytorch', title: 'PyTorch', type: 'required', xp: 20, prerequisites: ['sklearn', 'math'], difficulty: 'intermediate', time: '10 hrs', description: 'Tensors, autograd, nn.Module, training loop, GPU usage. PyTorch is the default framework at top product companies.', x: 230, y: 320, width: 130, height: 60 },
    ...
    { id: 'llms', title: 'LLMs & Fine-tuning', type: 'recommended', xp: 20, prerequisites: ['pytorch'], difficulty: 'advanced', time: '10 hrs', description: 'Transformers architecture, HuggingFace, LoRA fine-tuning, RLHF concepts. In-demand at every startup in 2025–26.', x: 305, y: 420, width: 130, height: 60 },
    { id: 'cloud', title: 'SageMaker / Vertex AI', type: 'required', xp: 15, prerequisites: ['mlops'], difficulty: 'advanced', time: '8 hrs', description: 'Managed training jobs, endpoints, pipelines. Most enterprises expect cloud ML platform experience.', x: 455, y: 420, width: 130, height: 60 },
  ],
  edges: [

...
export const dataEngineerRoadmap: Roadmap = {
  ...
  nodes: [
    ...
    },
    {
      ...
      difficulty: 'beginner',
      time: '3–4 hrs',
      description: 'First real ADF pipeline. FreshCart store data. Blob → ADLS Gen2. Every error you will hit is documented in the Error Library.',
    ...
    },
    {
      ...
      difficulty: 'beginner',
      time: '4–5 hrs',
      description: 'Copy all 10 FreshCart stores in one pipeline run using ForEach. Critical rule: ForEach must be Sequential, not Parallel, when writing to variables.',

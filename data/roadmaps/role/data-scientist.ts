...
export const dataScientistRoadmap: Roadmap = {
  ...
  category: 'role',
  description: 'From Python and statistics fundamentals through machine learning, experimentation, and business storytelling. Built for the US job market — Palantir, Amazon, and top analytics teams.',
  level: 'beginner',
  estimatedTime: '4–6 months',
  salaryData: [
    { company: 'Analytics firm (Palantir)', range: '$80K–$105K', note: 'Entry-level data analyst track' },
    { company: 'Product startup', range: '$135K–$175K', note: 'Amazon, DoorDash, Shopify' },
    { company: 'Enterprise / Consulting', range: '$170K–$210K', note: 'BCG Gamma, Deloitte Analytics' },
    { company: 'FAANG', range: '$200K–$260K', note: 'PhD preferred but not mandatory' },
  ],
  nodes: [
    ...
    { id: 'timeseries', title: 'Time Series', type: 'optional', xp: 10, prerequisites: ['ml'], difficulty: 'intermediate', time: '5 hrs', description: 'ARIMA, Prophet, stationarity, decomposition. Demand forecasting is a major use case at DoorDash, Amazon, and logistics firms.', x: 80, y: 420, width: 130, height: 60 },

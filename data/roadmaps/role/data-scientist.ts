...
export const dataScientistRoadmap: Roadmap = {
  ...
  category: 'role',
  description: 'From Python and statistics fundamentals through machine learning, experimentation, and business storytelling. Built for the Indian market — Fractal, Palantir, Amazon, and MNC analytics teams.',
  level: 'beginner',
  estimatedTime: '4–6 months',
  salaryData: [
    { company: 'Analytics firm (Palantir / Tiger)', range: '₹6–10 LPA', note: 'Entry-level data analyst track' },
    { company: 'Product startup', range: '₹14–26 LPA', note: 'Amazon, DoorDash, Shopify' },
    { company: 'MNC / Consulting GCC', range: '₹18–35 LPA', note: 'BCG Gamma, Deloitte Analytics' },
    { company: 'FAANG', range: '₹35–60 LPA', note: 'PhD preferred but not mandatory' },
  ],
  nodes: [

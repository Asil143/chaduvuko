...
export const PAGE_ORDER: PageMeta[] = [
  ...
  // Apache Kafka Track
  { href: '/learn/apache-kafka/what-is-apache-kafka',        title: 'What is Apache Kafka?',                         section: 'Apache Kafka', difficulty: 'Beginner',     color: '#f97316', readTime: '16 min', xp: 100 },
  { href: '/learn/apache-kafka/events-topics-partitions',    title: 'Events, Topics, and Partitions',                section: 'Apache Kafka', difficulty: 'Beginner',     color: '#f97316', readTime: '18 min', xp: 100 },
  { href: '/learn/apache-kafka/producers-consumers-brokers', title: 'Producers, Consumers, and Brokers',             section: 'Apache Kafka', difficulty: 'Beginner',     color: '#f97316', readTime: '17 min', xp: 100 },
  { href: '/learn/apache-kafka/local-setup-cli',             title: 'Local Setup and Kafka CLI',                     section: 'Apache Kafka', difficulty: 'Beginner',     color: '#f97316', readTime: '21 min', xp: 100 },
  { href: '/learn/apache-kafka/consumer-groups-offsets',     title: 'Consumer Groups and Offsets',                   section: 'Apache Kafka', difficulty: 'Intermediate', color: '#06b6d4', readTime: '21 min', xp: 150 },
  { href: '/learn/apache-kafka/replication-leaders-isr',     title: 'Replication, Leaders, and ISR',                 section: 'Apache Kafka', difficulty: 'Intermediate', color: '#06b6d4', readTime: '23 min', xp: 150 },
  { href: '/learn/apache-kafka/keys-ordering-partitioning',  title: 'Keys, Ordering, and Partitioning Strategy',     section: 'Apache Kafka', difficulty: 'Intermediate', color: '#06b6d4', readTime: '21 min', xp: 150 },
  { href: '/learn/apache-kafka/retention-compaction',        title: 'Retention and Log Compaction',                  section: 'Apache Kafka', difficulty: 'Intermediate', color: '#06b6d4', readTime: '21 min', xp: 150 },
  { href: '/learn/apache-kafka/delivery-semantics',          title: 'Delivery Semantics: At-Most, At-Least, Exactly-Once', section: 'Apache Kafka', difficulty: 'Intermediate', color: '#06b6d4', readTime: '24 min', xp: 150 },
  { href: '/learn/apache-kafka/schemas-serialization',       title: 'Serialization and Schema Design',               section: 'Apache Kafka', difficulty: 'Intermediate', color: '#22c55e', readTime: '23 min', xp: 150 },
  { href: '/learn/apache-kafka/producer-design',             title: 'Producer Design',                               section: 'Apache Kafka', difficulty: 'Intermediate', color: '#22c55e', readTime: '23 min', xp: 150 },
  { href: '/learn/apache-kafka/consumer-design',             title: 'Consumer Design',                               section: 'Apache Kafka', difficulty: 'Intermediate', color: '#22c55e', readTime: '24 min', xp: 150 },
  { href: '/learn/apache-kafka/kafka-connect',               title: 'Kafka Connect',                                 section: 'Apache Kafka', difficulty: 'Intermediate', color: '#22c55e', readTime: '23 min', xp: 150 },
  { href: '/learn/apache-kafka/stream-processing-kafka-streams', title: 'Stream Processing and Kafka Streams',       section: 'Apache Kafka', difficulty: 'Intermediate', color: '#22c55e', readTime: '26 min', xp: 150 },
  { href: '/learn/apache-kafka/security-acls-sasl-tls',      title: 'Kafka Security: TLS, SASL, and ACLs',           section: 'Apache Kafka', difficulty: 'Advanced',     color: '#8b5cf6', readTime: '26 min', xp: 200 },
  { href: '/learn/apache-kafka/monitoring-observability',    title: 'Monitoring and Observability',                  section: 'Apache Kafka', difficulty: 'Advanced',     color: '#8b5cf6', readTime: '24 min', xp: 200 },
  { href: '/learn/apache-kafka/performance-tuning',          title: 'Performance Tuning',                            section: 'Apache Kafka', difficulty: 'Advanced',     color: '#8b5cf6', readTime: '26 min', xp: 200 },
  { href: '/learn/apache-kafka/scaling-capacity-planning',   title: 'Scaling and Capacity Planning',                 section: 'Apache Kafka', difficulty: 'Advanced',     color: '#8b5cf6', readTime: '26 min', xp: 200 },
  { href: '/learn/apache-kafka/disaster-recovery-multi-region', title: 'Disaster Recovery and Multi-Region Kafka',   section: 'Apache Kafka', difficulty: 'Advanced',     color: '#8b5cf6', readTime: '28 min', xp: 200 },
  { href: '/learn/apache-kafka/event-driven-architecture',   title: 'Event-Driven Architecture',                     section: 'Apache Kafka', difficulty: 'Advanced',     color: '#ef4444', readTime: '26 min', xp: 200 },
  { href: '/learn/apache-kafka/cdc-debezium',                title: 'Change Data Capture with Debezium',             section: 'Apache Kafka', difficulty: 'Advanced',     color: '#ef4444', readTime: '26 min', xp: 200 },
  { href: '/learn/apache-kafka/managed-kafka-cloud',         title: 'Managed Kafka and Cloud Choices',               section: 'Apache Kafka', difficulty: 'Intermediate', color: '#ef4444', readTime: '21 min', xp: 150 },

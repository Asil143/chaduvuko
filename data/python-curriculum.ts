...
export const PYTHON_CURRICULUM: PythonSection[] = [
  {
    ...
    modules: [
      { id: 1, slug: 'what-is-python-setup', title: 'What is Python? Setup & Your First Program', description: 'Why Python is the most in-demand language in the US job market, how it actually runs, and getting a real environment set up — no confusion, no skipped steps.', tags: ['Why Python', 'Interpreter vs compiler', 'Installing Python', 'venv', 'Your first script'], status: 'live', readTime: '35 min', xp: 100 },
      { id: 2, slug: 'variables-data-types', title: 'Variables, Data Types & Type Conversion', description: 'Every value in Python is an object. Variables, the core data types, dynamic typing, and how to convert safely between them without silent bugs.', tags: ['Variables', 'int/float/str/bool', 'Dynamic typing', 'Type conversion', 'None'], status: 'live', readTime: '40 min', xp: 100 },
      { id: 3, slug: 'operators', title: 'Operators — Arithmetic, Comparison, Logical', description: 'Every operator Python has, what it actually does under the hood, and the precedence rules that cause real bugs when ignored.', tags: ['Arithmetic', 'Comparison', 'Logical', 'Precedence', 'Walrus operator'], status: 'live', readTime: '30 min', xp: 100 },
      { id: 4, slug: 'strings', title: 'Strings — Creation, Indexing, Slicing, Methods', description: 'Strings are the data type you will touch the most. Indexing, slicing, the methods that matter, and f-strings done right.', tags: ['Indexing', 'Slicing', 'String methods', 'f-strings', 'Immutability'], status: 'live', readTime: '45 min', xp: 150 },
      { id: 5, slug: 'control-flow', title: 'Control Flow — if / elif / else', description: 'How Python actually evaluates truthiness, every form of conditional logic, and the readability patterns senior engineers actually use.', tags: ['if/elif/else', 'Truthy/falsy', 'Ternary expressions', 'Nested conditions'], status: 'live', readTime: '30 min', xp: 100 },

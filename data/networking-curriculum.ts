...
export const NETWORKING_CURRICULUM: NetSection[] = [
  ...
  },
  {
    ...
    modules: [
      ...
      { id: 36, slug: 'vpns-and-tunneling',        title: 'VPNs and Tunneling — IPSec, SSL, WireGuard',          description: 'How VPNs encrypt and encapsulate traffic — IKEv2, OpenVPN, WireGuard compared byte by byte',    tags: ['VPN','IPSec','IKEv2','OpenVPN','WireGuard','Tunnel mode','Transport mode','Split tunneling','GRE'],  status: 'soon', readTime: '20–28 min' },
      { id: 37, slug: 'wireless-security',         title: 'Wireless Security — WPA2/WPA3 Attacks',               description: 'KRACK, PMKID attack, deauth frames, evil twin AP, rogue AP detection — complete wireless attack surface', tags: ['WPA2','WPA3','KRACK','PMKID','4-way handshake','Deauth','Evil twin','aircrack-ng','hcxtools'],       status: 'soon', readTime: '20–28 min' },
      { id: 38, slug: 'zero-trust-networking',     title: 'Zero Trust Networking — Never Trust, Always Verify',  description: 'BeyondCorp, microsegmentation, identity-based perimeter, ZTNA vs VPN — the architecture replacing VPNs', tags: ['Zero trust','BeyondCorp','Microsegmentation','ZTNA','Identity perimeter','SDP','SASE','mTLS'],       status: 'soon', readTime: '16–22 min' },
      { id: 39, slug: 'ddos',                      title: 'DDoS — How It Works and How to Defend Against It',    description: 'Volumetric, protocol, application layer — Cloudflare, AWS Shield, anycast — real attack breakdowns', tags: ['DDoS','Volumetric','SYN flood','HTTP flood','Amplification','Cloudflare','BGP anycast','Rate limiting'], status: 'soon', readTime: '18–24 min' },
    ],
  },
  {
    id: 7, title: 'Tools and Troubleshooting', color: '#f59e0b', difficulty: 'Advanced',
    modules: [
      { id: 40, slug: 'network-troubleshooting',   title: 'Network Troubleshooting Methodology',                 description: 'The OSI-layer-by-layer methodology that resolves 90% of issues — with every command you run at each step', tags: ['Troubleshooting','ping','traceroute','nslookup','netstat','ss','ip route','arp -a','Methodology'],   status: 'soon', readTime: '18–24 min' },
      { id: 41, slug: 'wireshark',                 title: 'Wireshark — Packet Analysis Complete Guide',          description: 'Capture filters, display filters, following streams, decrypting TLS, real-world pcap analysis',  tags: ['Wireshark','Capture filter','Display filter','TCP stream','pcap','Decrypting TLS','Protocol dissector'], status: 'soon', readTime: '22–30 min' },
      { id: 42, slug: 'tcpdump',                   title: 'tcpdump — Command-Line Packet Capture',               description: 'BPF filter syntax, writing pcaps, piping to Wireshark — the tool every Linux engineer needs',    tags: ['tcpdump','BPF','Capture filter','pcap','-w flag','-r flag','Expressions','Remote capture'],          status: 'soon', readTime: '16–22 min' },
      { id: 43, slug: 'nmap',                      title: 'Nmap — Network Scanning and Host Discovery',          description: 'SYN scan, OS fingerprinting, NSE scripts, timing, evading firewalls — complete offensive and defensive use', tags: ['Nmap','SYN scan','-sV','-O','NSE','Timing','Firewall evasion','Host discovery','Port states'],       status: 'soon', readTime: '20–28 min' },
      { id: 44, slug: 'network-monitoring',        title: 'Network Monitoring — NetFlow, SNMP Polling, Dashboards', description: 'How enterprise networks are observed at scale — NetFlow, SNMP polling, Grafana, alerting',      tags: ['NetFlow','sFlow','SNMP polling','Grafana','Prometheus','Alertmanager','Bandwidth monitoring','NOC'],  status: 'soon', readTime: '16–22 min' },
    ],
  },
]

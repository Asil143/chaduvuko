...
export const AIML_SECTIONS: Section[] = [
  ...
  },
  {
    ...
    topics: [
      ...
      { slug: 'eigenvalues-eigenvectors',  title: 'Eigenvalues and Eigenvectors',                     status: 'soon' },
  ...
  },
  {
    ...
    topics: [
      ...
      { slug: 'train-val-test-split',          title: 'Train / Validation / Test Split',                     status: 'soon' },
    ],
  },
  {
    slug: 'classical-ml',
    ...
    topics: [
      ...
      { slug: 'xgboost',             title: 'XGBoost in Practice',                      status: 'soon' },
      { slug: 'lightgbm',            title: 'LightGBM — Fast Gradient Boosting',        status: 'soon' },
  ...
  },
  {
    ...
    color: '#BA7517',
    topics: [
      { slug: 'classification-metrics', title: 'Classification Metrics — Precision, Recall, F1, AUC', status: 'soon' },

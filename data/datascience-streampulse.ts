...
export const DS_CURRICULUM: DSSection[] = [
  {
    ...
    modules: [
      ...
      { id: 2, slug: 'data-science-workflow', title: 'The Data Science Workflow', description: 'From a vague business question to a shipped decision — the six stages every real project moves through', tags: ['Problem framing', 'Data collection', 'EDA', 'Modeling', 'Communication'], status: 'live', readTime: '12–16 min' },
      { id: 3, slug: 'ds-vs-other-roles', title: 'Data Science vs Data Engineering vs ML Engineering vs Analytics', description: 'Four job titles that get confused constantly — what each one actually owns day to day', tags: ['DS vs DE', 'DS vs ML Eng', 'DS vs Analyst', 'Career paths'], status: 'live', readTime: '10–14 min' },

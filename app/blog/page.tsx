...
const posts = [
  // FEATURED
  { slug: 'medallion-architecture-explained',     title: 'Medallion Architecture Explained — Bronze, Silver, and Gold in Plain English',          excerpt: 'The most widely used data lake design pattern in 2026. What each layer means, why it exists, and how to implement it on Azure, AWS, and GCP.',           date: 'March 1, 2026',     readTime: '8 min read',  tags: ['Architecture', 'Data Lake'],         featured: true },
  { slug: 'how-to-get-h1b-data-engineering',      title: 'How to Get H1B Sponsorship as a Data Engineer in 2026',                                  excerpt: 'The companies that actually sponsor, what skills they look for, the resume strategy that works, and the exact timing of when to apply.',                date: 'March 15, 2026',    readTime: '8 min read',  tags: ['H1B', 'Career'],                     featured: true },
  { slug: 'azure-vs-aws-data-engineering',        title: 'Azure vs AWS for Data Engineers in 2026 — A Real Comparison',                            excerpt: 'ADF vs Glue, Databricks vs EMR, Synapse vs Redshift. A direct comparison focused on what a data engineer actually uses every day.',                   date: 'February 28, 2026', readTime: '7 min read',  tags: ['Azure', 'AWS'],                      featured: true },
  { slug: 'spark-interview-questions',            title: '15 PySpark Interview Questions Asked at Real Data Engineering Roles',                     excerpt: 'Real PySpark questions from consulting firms, financial services, and tech companies. With the answers interviewers actually want to hear.',           date: 'March 5, 2026',     readTime: '10 min read', tags: ['Interview', 'Apache Spark'],          featured: true },
  // ALL ARTICLES
  { slug: 'delta-lake-vs-apache-iceberg',         title: 'Delta Lake vs. Apache Iceberg — Which Should You Use?',                                  excerpt: 'Two open table formats that bring ACID transactions to your data lake. Different strengths, different ecosystems, different ideal use cases.',           date: 'February 22, 2026', readTime: '10 min read', tags: ['Storage', 'Architecture'],            featured: false },
  { slug: 'data-engineer-resume-without-experience', title: 'How to Write a Data Engineer Resume With No Work Experience',                          excerpt: 'The resume strategy that gets callbacks at consulting firms sponsoring H1B. What to include, what to cut, and how to quantify project work.',            date: 'February 15, 2026', readTime: '12 min read', tags: ['Career', 'Resume'],                  featured: false },
  { slug: 'adf-vs-airflow-vs-step-functions',     title: 'ADF vs. Airflow vs. Step Functions — Which Orchestration Tool to Learn?',                excerpt: 'Three orchestration tools compared. When to use each, what they are good at, and which one has the most job market demand.',                           date: 'February 8, 2026',  readTime: '9 min read',  tags: ['Orchestration', 'ADF'],              featured: false },
  { slug: 'microsoft-fabric-explained',           title: 'Microsoft Fabric Explained — Should You Learn It Now or Wait?',                          excerpt: 'The biggest change to the Azure data engineering landscape since Databricks. What it is, what it replaces, and the honest advice on timing.',           date: 'February 1, 2026',  readTime: '7 min read',  tags: ['Azure', 'Microsoft Fabric'],         featured: false },
  { slug: 'why-data-engineers-use-parquet',       title: 'Why Data Engineers Use Parquet Instead of CSV',                                          excerpt: 'CSV vs Parquet — what actually happens in production and why every serious pipeline uses columnar format for storage and query performance.',            date: 'March 10, 2026',    readTime: '5 min read',  tags: ['Foundations', 'Storage'],            featured: false },
  { slug: 'apache-spark-architecture-explained',  title: 'Apache Spark Architecture Explained — How Spark Actually Works',                         excerpt: 'Drivers, executors, DAGs, stages — the internals that separate engineers who can debug slow jobs from those who just restart the cluster.',             date: 'March 18, 2026',    readTime: '8 min read',  tags: ['Apache Spark', 'Architecture'],      featured: false },
  { slug: 'data-quality-in-pipelines',            title: 'Data Quality in Production Pipelines — What to Check and When',                          excerpt: 'Bad data flowing silently is worse than a broken pipeline. The four categories of data quality issues and exactly where to apply checks.',               date: 'March 17, 2026',    readTime: '7 min read',  tags: ['Architecture', 'Foundations'],       featured: false },
  { slug: 'what-is-a-data-lakehouse',             title: 'What Is a Data Lakehouse? The Architecture Replacing the Data Warehouse',                 excerpt: 'Warehouse reliability at lake cost. How Delta Lake, Iceberg, and Microsoft Fabric are all built around this single architectural shift.',                date: 'March 16, 2026',    readTime: '6 min read',  tags: ['Architecture', 'Foundations'],       featured: false },
  { slug: 'adls-gen2-best-practices',             title: 'ADLS Gen2 Best Practices — How to Structure Your Azure Data Lake',                       excerpt: 'Container structure, partitioning strategy, access controls, and the small files problem. The mistakes made early are expensive to fix at scale.',       date: 'March 14, 2026',    readTime: '6 min read',  tags: ['Azure', 'Storage'],                  featured: false },
  { slug: 'azure-key-vault-for-data-engineers',   title: 'Azure Key Vault for Data Engineers — Stop Putting Secrets in Your Code',                 excerpt: 'Secrets in code are the most common security mistake in data engineering. Key Vault with Databricks and ADF — set up properly in 15 minutes.',           date: 'March 13, 2026',    readTime: '5 min read',  tags: ['Azure', 'Security'],                 featured: false },
  { slug: 'what-is-apache-kafka',                 title: 'What Is Apache Kafka? A Plain English Explanation for Data Engineers',                    excerpt: 'Not just a message queue. Why Kafka changed how companies build data pipelines and what makes it different from every alternative.',                     date: 'March 12, 2026',    readTime: '7 min read',  tags: ['Streaming', 'Architecture'],         featured: false },
  { slug: 'slowly-changing-dimensions-explained', title: 'Slowly Changing Dimensions Explained — SCD Type 1, 2, and 3',                            excerpt: 'How to handle changes to dimension data over time. Getting this decision wrong can corrupt your entire historical analysis.',                           date: 'March 11, 2026',    readTime: '6 min read',  tags: ['Architecture', 'Foundations'],       featured: false },
  { slug: 'etl-vs-elt-explained',                 title: 'ETL vs ELT — Why the Industry Switched and What It Means for Your Work',                 excerpt: 'Why the industry moved from ETL to ELT, what cloud storage costs have to do with it, and when ETL is still the right choice.',                          date: 'March 9, 2026',     readTime: '5 min read',  tags: ['Foundations', 'Architecture'],       featured: false },
  { slug: 'aws-glue-vs-databricks',               title: 'AWS Glue vs Databricks on AWS — Which Should You Use?',                                  excerpt: 'Both run Spark on AWS. When serverless Glue is the right call and when Databricks is worth the extra cost.',                                           date: 'March 8, 2026',     readTime: '6 min read',  tags: ['AWS', 'Apache Spark'],               featured: false },
  { slug: 'redshift-vs-bigquery-vs-synapse',      title: 'Redshift vs BigQuery vs Synapse — Choosing a Cloud Data Warehouse',                      excerpt: 'Architecture, cost patterns, and ecosystem integration for the three dominant cloud data warehouses. Which to learn for your target job market.',          date: 'March 7, 2026',     readTime: '7 min read',  tags: ['AWS', 'GCP', 'Azure'],               featured: false },
  { slug: 'bigquery-cost-optimization',           title: 'BigQuery Cost Optimization — Stop Paying for Queries You Do Not Need',                   excerpt: 'Partitioning, clustering, avoiding SELECT *, and materialized views. The practical changes that cut BigQuery bills dramatically.',                        date: 'March 6, 2026',     readTime: '6 min read',  tags: ['GCP', 'BigQuery'],                   featured: false },
  { slug: 'cloud-composer-vs-managed-airflow',    title: 'Cloud Composer vs Self-Managed Airflow — What GCP Engineers Should Know',                excerpt: 'What Composer manages for you, the real cost tradeoff, and when it makes sense vs running Airflow yourself.',                                           date: 'March 4, 2026',     readTime: '5 min read',  tags: ['GCP', 'Orchestration'],              featured: false },
  { slug: 'dataflow-vs-spark-streaming',          title: 'Google Dataflow vs Apache Spark Streaming — Stream Processing Compared',                  excerpt: 'Two streaming engines with different models. Latency, cost, ease of use, and which one GCP data engineering roles actually require.',                    date: 'March 3, 2026',     readTime: '6 min read',  tags: ['GCP', 'Streaming'],                  featured: false },
  { slug: 'pubsub-vs-kafka-vs-kinesis',           title: 'Pub/Sub vs Kafka vs Kinesis — Choosing a Streaming Ingestion Layer',                     excerpt: 'Every real-time pipeline needs a message broker. How the three major options compare on retention, throughput, and ecosystem fit.',                      date: 'March 2, 2026',     readTime: '6 min read',  tags: ['GCP', 'Streaming'],                  featured: false },
  { slug: 'gcp-iam-for-data-engineers',           title: 'GCP IAM for Data Engineers — Access Control Without the Confusion',                      excerpt: 'Members, roles, bindings, and service accounts. The practical IAM setup for Dataflow pipelines, Composer DAGs, and BigQuery access.',                  date: 'February 28, 2026', readTime: '5 min read',  tags: ['GCP', 'Security'],                   featured: false },
  { slug: 'kinesis-firehose-explained',           title: 'Amazon Kinesis Firehose Explained — Stream Data into S3 Without Consumer Code',          excerpt: 'The easiest AWS streaming service. How Firehose auto-delivers to S3 with date partitioning and Lambda transformation built in.',                        date: 'February 26, 2026', readTime: '5 min read',  tags: ['AWS', 'Streaming'],                  featured: false },
  { slug: 'redshift-best-practices',              title: 'Amazon Redshift Best Practices — Distribution Keys, Sort Keys, and Vacuum',              excerpt: 'A poorly configured Redshift cluster can be 100x slower. The three decisions that define query performance at scale.',                                 date: 'February 25, 2026', readTime: '7 min read',  tags: ['AWS', 'Storage'],                    featured: false },
  { slug: 'aws-s3-for-data-engineers',            title: 'Amazon S3 for Data Engineers — Beyond Just File Storage',                                excerpt: 'Lifecycle policies, event notifications, S3 Select, and partitioning strategy. Features most engineers never learn but use every day.',                  date: 'February 24, 2026', readTime: '6 min read',  tags: ['AWS', 'Storage'],                    featured: false },
  { slug: 'data-engineering-career-path',         title: 'The Data Engineering Career Path — Junior to Senior in 3 Years',                         excerpt: 'The skills and milestones that actually matter at each level, salary ranges at each stage, and the fastest path from zero to senior.',                    date: 'February 23, 2026', readTime: '8 min read',  tags: ['Career'],                            featured: false },
  { slug: 'what-is-dbt',                          title: 'What Is dbt? The Data Transformation Tool Everyone Is Talking About',                     excerpt: 'What dbt actually does, why it became popular, dbt Core vs dbt Cloud, and whether you should add it to your learning list in 2026.',                    date: 'February 20, 2026', readTime: '6 min read',  tags: ['Foundations', 'Architecture'],       featured: false },
  { slug: 'incremental-loading-explained',        title: 'Incremental Loading — How to Process Only New Data in Your Pipelines',                    excerpt: 'Full load vs incremental, watermark patterns, handling late arrivals, and change data capture. The production pattern every DE needs.',                  date: 'February 18, 2026', readTime: '6 min read',  tags: ['Architecture', 'Foundations'],       featured: false },
  { slug: 'batch-vs-streaming',                   title: 'Batch vs. Streaming — The Decision Framework Every Data Engineer Needs',                  excerpt: 'The 4-question framework for choosing between batch and streaming. When streaming is overkill and when you genuinely need it.',                          date: 'January 25, 2026',  readTime: '6 min read',  tags: ['Architecture', 'Streaming'],         featured: false },
]

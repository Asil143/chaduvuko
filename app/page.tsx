...
const tracksAll = [
  ...
  { cat:'data',  icon:'◎',  name:'Apache Kafka',           desc:'Event streaming from scratch to advanced production systems', pills:['Events','Topics','Consumers','Connect','Streams'], jobs:'Data Engineer · Backend Engineer · Platform Engineer', status:'live', href:'/learn/apache-kafka' },
...
{ cat:'ai', icon:'🔍', name:'MLOps',                   desc:'Deploy and monitor ML in production',  pills:['MLflow','Docker','Kubeflow','CI/CD'],         jobs:'MLOps Engineer · ML Platform Eng', status:'soon', href:'/learn/ai-ml' },
  ...
  { cat:'data',  icon:'🔧',  name:'dbt',                    desc:'The analytics engineering transformation layer', pills:['Models','Jinja','Testing','Incremental','CI/CD'], jobs:'Analytics Engineer · Data Engineer', status:'live', href:'/learn/dbt' },
  // CS Core

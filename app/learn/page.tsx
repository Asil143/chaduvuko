...
const SKILLS = [
  ...
  { badge: 'Database', title: 'Snowflake', status: 'live' as const, href: '/learn/snowflake', desc: 'Cloud data warehouse platform — architecture, warehouses, loading, Time Travel, Streams, Tasks, dbt, security, and cost.', pills: ['Warehouses', 'COPY INTO', 'Time Travel', 'Streams', 'Tasks', 'dbt'] },
  { badge: 'Data Engineering', title: 'dbt', status: 'live' as const, href: '/learn/dbt', desc: 'The analytics engineering transformation layer — models, sources, testing, documentation, Jinja, incremental models, snapshots, and CI/CD.', pills: ['Models', 'Jinja', 'Testing', 'Incremental', 'Snapshots', 'CI/CD'] },
  // CS Core

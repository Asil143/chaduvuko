...
-- Second UPDATE fails the available >= qty check → out of stock`}
        ...
        <QA n={60} q="If you had to design the database architecture for a payment system like Stripe, what would it look like?" color="var(--accent)" level="Senior">

...
export const metadata = { title: 'DATABRICKS' }

export default function Page() {
  return (
    <LearnLayout
      title="Azure Databricks"
      description="Azure Databricks is where the real transformation work happens. It brings Apache Spark as a fully managed, cloud-optimized service — the primary processing engine for large-scale data engineering."
    ...
    >
      ...
      <p>
        This tutorial will cover every aspect of Azure Databricks from first principles — setting up clusters, writing PySpark notebooks, using Delta Lake, reading from ADLS Gen2, and integrating with ADF for orchestration.. Built for real job readiness, not just theory.
      </p>

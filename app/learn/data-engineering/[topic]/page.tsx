...
const moduleMap: Record<string, () => Promise<{ default: React.ComponentType }>> = {
  ...
  'de-usa-job-market':            () => import('@/content/data-engineering/de-usa-job-market'),
...
const moduleMeta: Record<string, { title: string; description: string }> = {
  ...
  'de-usa-job-market':            { title: 'Data Engineering in the US Job Market (2026)',         description: 'Real salary data, top hiring companies, skills in JDs, breaking in from non-CS.'              },

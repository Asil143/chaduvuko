...
const modules: Module[] = [
  ...
  {
    num: '19', section: 5, color: sectionColors[5], status: 'live', xp: 100,
    readTime: '25–30 min',
  ...
  { num: '21', section: 5, color: sectionColors[5], status: 'soon', xp: 100, readTime: '30 min', title: 'Support Vector Machines — Margin Maximisation', description: 'The algorithm that finds the widest possible boundary between classes. Kernels, the kernel trick, and why SVMs still matter for small high-dimensional datasets.', topics: ['SVM', 'Margin', 'Kernels', 'Hyperplane'] },
  { num: '22', section: 5, color: sectionColors[5], status: 'soon', xp: 100, readTime: '25 min', title: 'K-Nearest Neighbours — Similarity-Based Prediction', description: 'The simplest possible ML algorithm — predict based on what your neighbours look like. Distance metrics, the curse of dimensionality, and when KNN actually works.', topics: ['KNN', 'Distance', 'Euclidean', 'Curse of dimensionality'] },
  { num: '23', section: 5, color: sectionColors[5], status: 'soon', xp: 100, readTime: '25 min', title: 'Naive Bayes — Probabilistic Text Classification', description: 'Bayes theorem applied to classification. Why the naive independence assumption works surprisingly well for spam filters and document classification.', topics: ['Naive Bayes', 'Bayes theorem', 'Probabilistic', 'Text classification'] },
  {
  ...
  { num: '27', section: 5, color: sectionColors[5], status: 'soon', xp: 100, readTime: '35 min', title: 'LightGBM — Fast Gradient Boosting at Scale', description: 'Microsoft\'s answer to XGBoost. Leaf-wise tree growth, histogram-based splitting, and why LightGBM trains 10x faster on large datasets.', topics: ['LightGBM', 'Leaf-wise', 'Histogram', 'GBDT'] },
  {
    num: '28', section: 5, color: sectionColors[5], status: 'soon', xp: 100,
    readTime: '25 min',
  ...
  {
    num: '31', section: 6, color: sectionColors[6], status: 'soon', xp: 100,
    readTime: '20 min',
  ...
  {
    num: '32', section: 6, color: sectionColors[6], status: 'soon', xp: 100,
    readTime: '30 min',
  ...
  {
    num: '33', section: 6, color: sectionColors[6], status: 'soon', xp: 100,
    readTime: '35 min',
  ...
  {
    num: '38', section: 7, color: sectionColors[7], status: 'soon', xp: 100,
    readTime: '30 min',
  ...
  {
    num: '39', section: 7, color: sectionColors[7], status: 'soon', xp: 100,
    readTime: '50 min',
  ...
  {
    num: '44', section: 8, color: sectionColors[8], status: 'soon', xp: 100,
    readTime: '40 min',
  ...
  {
    num: '45', section: 8, color: sectionColors[8], status: 'soon', xp: 100,
    readTime: '45 min',
  ...
  {
    num: '46', section: 8, color: sectionColors[8], status: 'soon', xp: 100,
    readTime: '30 min',
  ...
  {
    num: '47', section: 8, color: sectionColors[8], status: 'soon', xp: 100,
    readTime: '40 min',
  ...
  {
    num: '50', section: 9, color: sectionColors[9], status: 'soon', xp: 100,
    readTime: '45 min',
  ...
  {
    num: '51', section: 9, color: sectionColors[9], status: 'soon', xp: 100,
    readTime: '50 min',
  ...
  {
    num: '52', section: 9, color: sectionColors[9], status: 'soon', xp: 100,
    readTime: '55 min',
  ...
  {
    num: '53', section: 9, color: sectionColors[9], status: 'soon', xp: 100,
    readTime: '40 min',
  ...
  {
    num: '56', section: 10, color: sectionColors[10], status: 'soon', xp: 100,
    readTime: '55 min',
  ...
  {
    num: '57', section: 10, color: sectionColors[10], status: 'soon', xp: 100,
    readTime: '40 min',
  ...
  {
    num: '58', section: 10, color: sectionColors[10], status: 'soon', xp: 100,
    readTime: '35 min',
  ...
  {
    num: '60', section: 11, color: sectionColors[11], status: 'soon', xp: 100,
    readTime: '50 min',
  ...
  {
    num: '61', section: 11, color: sectionColors[11], status: 'soon', xp: 100,
    readTime: '45 min',
  ...
  {
    num: '62', section: 11, color: sectionColors[11], status: 'soon', xp: 100,
    readTime: '45 min',
  ...
  {
    num: '63', section: 11, color: sectionColors[11], status: 'soon', xp: 100,
    readTime: '50 min',
  ...
  {
    num: '64', section: 11, color: sectionColors[11], status: 'soon', xp: 300,
    readTime: '90 min',

...
const modules: Module[] = [
  ...
  },
  {
    ...
    description: 'The first ML algorithm. Build a working DoorDash delivery time predictor from scratch — full intuition, math, code, 6 real errors, and a 5-day job walkthrough.',

...
const moduleMeta: Record<string, { title: string; description: string }> = {
  ...
  'classical-ml/decision-trees':                         { title: 'Decision Trees — Loan Approval at Capital One',        description: 'Gini impurity, information gain, pruning — the foundation of ensembles.'        },

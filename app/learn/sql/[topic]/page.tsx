...
const moduleMap: Record<string, () => Promise<{ default: React.ComponentType }>> = {
  ...
  'full-outer-join':                 () => import('@/content/sql/full-outer-join'),
...
'cross-join':                 () => import('@/content/sql/cross-join'),
   ...
   'correlated-subqueries':   () => import('@/content/sql/correlated-subqueries'),
    ...
    'date-time-functions':     () => import('@/content/sql/date-time-functions'),
    'math-functions':           () => import('@/content/sql/math-functions'),
    'cast-convert':           () => import('@/content/sql/cast-convert'),
    'views':                  () => import('@/content/sql/views'),
    'transactions':          () => import('@/content/sql/transactions'),
    'stored-procedures':       () => import('@/content/sql/stored-procedures'),
    'user-defined-functions': () => import('@/content/sql/user-defined-functions'),
    'triggers':               () => import('@/content/sql/triggers'),
  // 'ctes':                  () => import('@/content/sql/ctes'),
   'window-functions-intro': () => import('@/content/sql/window-functions-intro'),
  'ranking-functions':     () => import('@/content/sql/ranking-functions'),
  'analytics-lag-lead':     () => import('@/content/sql/analytics-lag-lead'),
  'recursive-cte':         () => import('@/content/sql/recursive-cte'),
  'explain-analyze':          () => import('@/content/sql/explain-analyze'),
  'index-strategies':          () => import('@/content/sql/index-strategies'),

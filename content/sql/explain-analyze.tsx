...
SHOW work_mem;`}
      ...
      <P>You are a backend engineer at Razorpay. A settlement report query that used to run in 2 seconds now takes 4 minutes. The database grew from 5 million to 50 million transactions over the last quarter. You have 30 minutes to diagnose and fix before the finance team's daily report runs.</P>
